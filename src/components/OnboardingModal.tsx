    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-lg bg-[var(--color-card)] rounded-2xl border border-[var(--color-border)] shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-center mb-5">
          <div className="w-12 h-12 rounded-2xl bg-[var(--color-primary)]/15 text-[var(--color-primary)] flex items-center justify-center mx-auto mb-2 border border-[var(--color-primary)]/30">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            aria-label={t('searchGamesToPick')}
            value={searchQuery}
        ...
        <div className="flex items-center justify-between text-xs font-semibold mb-3 px-1 text-[var(--color-text-secondary)]">
          ...
          <span className="text-[var(--color-secondary)]">RAWG/IGDB Sync Ready</span>
        </div>
            ...
            return (
              <div
                ...
                className={`group relative rounded-xl border-2 p-2 cursor-pointer transition-all flex flex-col justify-between ${
                  isSelected
                    ? 'border-[var(--color-primary)] bg-[var(--color-primary)]/10 shadow-md shadow-[var(--color-primary)]/20'
              ...
              >
                <div className="relative aspect-[3/4] rounded-lg overflow-hidden mb-2">
                  ...
                  {isSelected && (
                    <div className="absolute top-1.5 right-1.5 p-1 rounded-full bg-[var(--color-primary)] text-white shadow">
